...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240429103729_UpdatingDataBasee")]
    partial class UpdatingDataBasee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewLabelTopic", b =>
                {
                    b.Property<Guid>("LabelsNewLabelId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TopicIdTopic")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("LabelsNewLabelId", "TopicIdTopic");

                    b.HasIndex("TopicIdTopic");

                    b.ToTable("TopicLabels", (string)null);
                });
            ...
            modelBuilder.Entity("NewLabelTopic", b =>
                {
                    b.HasOne("Domain.Entities.NewLabel", null)
                        .WithMany()
                        .HasForeignKey("LabelsNewLabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
